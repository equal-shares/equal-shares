...
def test_equal_shares_fixed_budget_passed_example_1() -> None:
    voters = [1, 2, 3, 4, 5]
    ...
    expected_winners_allocations = {11: 200, 12: 0, 13: 200, 15: 350, 19: 0}
    expected_updated_cost = {11: 0, 12: 150, 13: 1, 15: 1, 19: 500}
    expected_candidates_payments_per_voter = {
        11: {1: 33.333333333333336, 2: 58.333333333333336, 4: 108.33333333333334},
        12: {2: 0, 5: 0},
        13: {1: 145.0, 5: 55.0},
    ...
    assert winners_allocation == expected_winners_allocations
    assert updated_cost == expected_updated_cost
...
def test_equal_shares_passed_example_1() -> None:
    voters = [1, 2, 3, 4, 5]
    projects_costs = {11: 100, 12: 150, 13: 200, 14: 250, 15: 300, 16: 350, 17: 400, 18: 450, 19: 500, 20: 550}
    bids = {
        11: {1: 100, 2: 100, 4: 100},
    ...
    assert winners_allocation == expected_winners_allocations
    assert candidates_payments_per_voter == expected_candidates_payments_per_voter


def test_equal_shares_passed_example_2() -> None:
    voters = [1, 2]
...
def test_equal_shares_fixed_budget_passed_example_2() -> None:
    voters = [1, 2, 3]
    projects_costs = {11: 100, 12: 100}
    # No increments
    bids = {
    ...
    expected_winners_allocations = {11: 175.0, 12: 125.0}
    expected_updated_cost = {11: 1, 12: 1}
    expected_candidates_payments_per_voter = {11: {1: 100.0, 2: 75.0}, 12: {2: 25.0, 3: 100.0}}
