...
if __name__ == "__main__":
   ...
   cost_min_max = [{1: (11000, 70000)}, {2: (1000, 40000)}, {3: (20000, 400000)}, {4: (2000, 10000)},
                    {5: (2000, 30000)}, {6: (35000, 85000)}, {7: (160000, 350000)}, {8: (500, 3000)},
                    {9: (500000, 1500000)}, {10: (30000, 90000)}, {11: (200000, 500000)}, {12: (30000, 80000)},
                    {13: (30000, 100000)}, {14: (2000, 10000)}, {15: (2000, 10000)}, {16: (1000, 60000)},
                    {17: (1000, 60000)}, {18: (15000, 50000)}, {19: (3000, 85000)}, {20: (4000, 10000)},
                    {21: (5000, 15000)}, {22: (1000, 15000)}, {23: (15000, 70000)}, {24: (20000, 100000)},
                    {25: (40000, 150000)}, {26: (5000, 50000)}, {27: (10000, 100000)}, {28: (6000, 60000)},
                    {29: (15000, 70000)}, {30: (100000, 200000)}, {31: (70000,150000)}]
   ...
   bids = {1: {1: 70000, 2: 0, 3: 44000, 4: 0, 5: 28000, 6: 11000, 7: 0, 8: 11000, 9: 20000},
   ...
   # T.4 For 4 projects with same cost and same voters, while the budget suffices for all the 1 ( take the first index) .
   print("T.4 Chack break_ties Function For 4 projects with same cost and same voters, while the budget suffices for all the 1 ( take the first index) ")
